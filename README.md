...
| `ESCALATION_FIRST_DELAY_MINUTES` | `30` | пауза после первого напоминания до повтора тому же человеку |
| `ESCALATION_STEP_MINUTES` | `5` | пауза между последующими шагами эскалации (повтор/следующий) |
